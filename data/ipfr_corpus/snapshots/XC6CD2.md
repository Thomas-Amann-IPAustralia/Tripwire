...
The status of the trade mark in the Register will be shown as ‘Accepted: In opposition period’ during this period. It will also contain an ‘application being considered’ notice above the application’s timeline. Check the status of the trade mark now, and ensure that less than two months have passed from the date of acceptance from Australian Trade Mark Search .
...
To begin the process, log into online services. and select ‘File an opposition’
See also
