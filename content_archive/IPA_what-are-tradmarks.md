...
The symbol should only be used next to the trade mark when it's used in its registered form. For example, if you've registered a

[logo trade mark](/trade-marks/what-are-trade-marks/kinds-of-trade-marks)that contains a word, you shouldn't use the ® symbol next to the word on its own.